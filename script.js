(function () {
  ...
  function finalizeFlow() {
    ...
    // You can continue your security questions flow here...
    // For demo, we show a message and options for next questions
    ...
    send.onclick = () => {
      ...
      // Special handling for time of delivery question if ETA is in future
